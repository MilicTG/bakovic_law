...
function Header() {
    return (
        <header className="bg-law-bck w-full h-[650px] xl:h-screen flex justify-center items-center bg-cover bg-center">
            <div className="relative container mx-auto h-full flex flex-col justify-center items-center xl:items-start px-4">
